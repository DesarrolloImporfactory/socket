...
exports.obtenerDashboardCompleto = catchAsync(async (req, res) => {
  ...
  try {
    ...
    await db.query('DROP TABLE IF EXISTS temp_primer_entrante', {
      transaction,
    });
    await db.query('DROP TABLE IF EXISTS temp_ultimo_entrante', {
      transaction,
    });
    await db.query('DROP TABLE IF EXISTS temp_ultimo_saliente', {
      transaction,
    });
